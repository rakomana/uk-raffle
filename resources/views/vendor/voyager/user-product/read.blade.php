            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-bordered" style="padding-bottom:5px;">
                    ...
                    <div class="panel-heading" style="border-bottom:0;">
                        &nbsp;<span><img src="{{ Voyager::image( 'users/default.png' ) }}" style="width:50px">
                        {{$user->name}}</span>
                        &nbsp;({{$user->email}})
                    </div>
                    <hr style="margin:0;">
                    ...
                    <div class="panel-heading" style="border-bottom:0;">
                        ...
                        <div class="panel-body" style="padding-top:0;">
                            @if($address == null)
                                null
                            @else
                                {{$address->address}},&nbsp;{{$address->unit}},&nbsp;{{$address->city}},&nbsp;{{$address->state}},&nbsp;{{$address->post_code}}
                            @endif
                        </div>
                    </div>
                    <hr style="margin:0;">
                    ...
                    <div class="panel-heading" style="border-bottom:0;">
                        ...
                        <div class="panel-body" style="padding-top:0;">
                            £{{($product->entry_price) * ($order->quantity)}}
                        </div>
                    </div>
                    <hr style="margin:0;">
                    <!-- end custom -->
